...
class BackendDatabaseRequires(Object):
    ...
    @property
    def postgres(self) -> PostgreSQLv0 | PostgreSQLv1 | None:
    ...
    def _on_database_created_non_leader(self, event: DatabaseCreatedEvent) -> None:
    ...
    def _on_database_created(self, event: DatabaseCreatedEvent) -> None:
        ...
        if not self.charm.unit.is_leader():
            self._on_database_created_non_leader(event)
            return

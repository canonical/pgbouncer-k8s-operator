...
class BackendDatabaseRequires(Object):
    ...
    def _on_database_created(self, event: DatabaseCreatedEvent) -> None:
        ...
        Deferrals:
            - If pgbouncer is not running
            - If backend doesn't exist
            - If we haven't added our database name to the app databag yet
                - This is because the backend charm has to create the database before we can use it
        """
